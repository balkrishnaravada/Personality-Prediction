        ...
        <div class="appnav navbar-expand-lg" id="student_nav">
          ...
          <c:if test="${scEmail  != null || hoEmail  != null }">
            ...
            <a class="nav-link dropdown-toggle" href="${pageContext.request.contextPath}/PatientServlet"
              ...
              <a class="nav-link dropdown-toggle"  href="${pageContext.request.contextPath}/ReportsServlet"  class="profile_link" style="float: left; font-weight: bold;font-size: 14px;"id="navbarDropdown" aria-expanded="false">
